    ...
    <!--div class="container-xxl py-5">
        <div class="container py-5">
            <div class="row g-5 align-items-center">
				...
				<?php
include("conn.php");
$select="select * from a_sell where id='$_REQUEST[id]'";
...
$row=mysqli_fetch_array($res)
                        ...
                        <form method="post" enctype="multipart/form-data">
                            <div class="row g-3">
							  <div class="col-12 col-sm-12">
								 ...
								 <div class="col-12 col-sm-12">
                                    <input type="hidden" class="form-control border-0" name="u_id"  value="<?php echo $row['u_id'];?>" style="height: 55px;">
                                </div>
                                ...
                                <div class="col-12 col-sm-6">
								   ...
								   <div class="col-12 col-sm-6">
                                    <input type="date" class="form-control border-0" name="cdate"   style="height: 55px;">
                                </div>
								     <div class="col-6">
                                      <select  class="form-control border-0" name="card"  style="height: 55px;">
                                  ...
                                  <div class="col-12 col-sm-12">
                                    <input type="text" class="form-control border-0" name="card_no"   placeholder="Card number" pattern="[0-9]{16}" title="Must contain at least 16 digit" style="height: 55px;" style="height: 55px;" required>
                                </div>
								 <div class="col-12 col-sm-6">
   ...
   include("conn.php");
	...
	if(isset($_POST['pay']))
	{
		...
		$cvv=$_POST['cvv'];
		$u_id=$_POST['u_id'];
		$insert="insert into u_payment(p_id,name,price,cdate,card,card_no,expdate,cvv,u_id)values('$p_id','$name','$price','$cdate','$card','$card_no','$expdate','$cvv','$u_id')";
	//echo $insert;
	
	$_SESSION['oid']=$_REQUEST['id'];
	
	mysqli_query($con,$insert);
	$up="update a_sell set date='$cdate' where p_id='$_REQUEST[id]'";
	mysqli_query($con,$up);

	echo '<script>alert("Success!")
									  window.location="invoice/index2.php";
									  </script>'; 
	}
