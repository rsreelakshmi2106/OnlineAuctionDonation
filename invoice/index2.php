...
$sql1="SELECT * FROM `a_sell` WHERE `id`='$id'";
 ...
 <div id="div_print" >
    <header class="clearfix">
      ...
      <div id="company" class="clearfix">
        ...
        <div>House No. 987, Elamkulam Lane, <br /> Elamkulam,Ernakulam, Kerala, India</div>
        <div>484-2675489</div>
      ...
      <table border=1>
		...
		$sql="SELECT * FROM `products` WHERE `id`='$cc1[p_id]'";
		$result=mysqli_query($con,$sql);
		$i=1;
		while($cc=mysqli_fetch_array($result))
		{
      ...
      ?>
		  <tr>
            <td class="service"><?php echo $cc['name']; ?></td>
