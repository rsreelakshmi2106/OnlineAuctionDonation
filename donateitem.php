...
$row=mysqli_fetch_array($res)
	...
	?>	
				...
				<br>
				  <div class="row g-5 align-items-center">
				  <center><h1 class="mb-5">Donate Item</h1></center>
				 </div>
...
include("conn.php");
		...
		if($_FILES['image']['name'])
    {
        ...
        $f=$_FILES['image']['name'];
        $ins="insert into products(u_id,name,category,disc,image,type,status)values('$u_id','$name','$category','$disc','$f','Donated','pending')";
